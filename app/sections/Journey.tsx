...
const milestones = [
  ...
  },
  {
    year: "Sekarang",
    tag: "Misi Baru",
    title: "Mentor & Partner Bisnismu",
    desc: "Kini Bagus membuka program mentoring intensif. Bukan sebagai guru yang mengajar dari atas — tapi sebagai partner yang menemani dari samping, dengan bekal pengalaman gagal yang nyata.",
    icon: "",
  },
];
